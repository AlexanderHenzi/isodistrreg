...
<p align="center"><strong>Available on <a href="https://cran.r-project.org/package=isodistrreg">CRAN</a></strong></p>
...
`install.packages("isodistrreg")`. If the installation fails on Linux because
of the error *Vignette re-building failed*, try installing with
